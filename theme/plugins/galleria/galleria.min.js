...
! function (a, b, c, d) {
    var e = b.document,
        ...
        w = function () {
            var b = [];
            return a.each(v.split(" "), function (a, c) {
        ...
        y = function (b) {
            return a.inArray(b, w) > -1 ? c[b.toUpperCase()] : b
        },
        z = {
            youtube: {
        ...
        A = function (c, d) {
            for (var e = 0; e < z._inst.length; e++)
                if (z._inst[e].id === d && z._inst[e].type == c) return z._inst[e];
            this.type = c, this.id = d, this.readys = [], z._inst.push(this);
            var f = this;
            a.extend(this, z[c]), _videoThumbs = function (b) {
        ...
        B = function (a) {
            var b;
            for (var c in z)
                if (b = a && z[c].reg && a.match(z[c].reg), b && b.length) return {
                    id: b[2],
                    provider: c
                };
            return !1
        ...
        C = {
            support: function () {
                var a = t().html;
                return !u && (a.requestFullscreen || a.msRequestFullscreen || a.mozRequestFullScreen || a.webkitRequestFullScreen)
            }(),
            callback: q,
            enter: function (a, b, c) {
                this.instance = a, this.callback = b || q, c = c || t().html, c.requestFullscreen ? c.requestFullscreen() : c.msRequestFullscreen ? c.msRequestFullscreen() : c.mozRequestFullScreen ? c.mozRequestFullScreen() : c.webkitRequestFullScreen && c.webkitRequestFullScreen()
            },
            exit: function (a) {
            ...
            listen: function () {
                if (this.support) {
                    var a = function () {
                        if (C.instance) {
                            var a = C.instance._fullscreen;
                            e.fullscreen || e.mozFullScreen || e.webkitIsFullScreen || e.msFullscreenElement && null !== e.msFullscreenElement ? a._enter(C.callback) : a._exit(C.callback)
                        }
                    };
        ...
        I = [],
        J = function (b) {
            I.push(b), a.each(H, function (a, c) {
            ...
            return {
                ...
                animate: function () {
                    var d, f, g, h, i, j, k, l = function (a) {
                            ...
                            if (b.opera) return !1;
                            for (c = 0; d[c]; c++)
                                if ("undefined" != typeof a[d[c]]) return d[c];
                            return !1
                    ...
                    return function (e, r, s) {
                        return s = a.extend({
                            ...
                            k = e.css(a), K.parseValue(k) != K.parseValue(b) && (d = !0), e.css(a, k)
                            ...
                            return function () {
                                b.one(d, function (a) {
                                    ...
                                    c in e && (j[a] = K.parseValue(e[c]) - K.parseValue(b.css(c)) + "px", i[c] = e[c], delete e[c])
                ...
                removeAlpha: function (a) {
                    if (a instanceof jQuery && (a = a[0]), s < 9 && a) {
                        var b = a.style,
                            c = a.currentStyle,
                ...
                revertStyles: function () {
                    a.each(K.array(arguments), function (b, c) {
                ...
                hide: function (b, c, d) {
                    ...
                    if (c) {
                        var g = s < 9 && b ? function () {
                            K.removeAlpha(b), b.style.visibility = "hidden", d.call(b)
                        } : d;
                        K.animate(b, f, {
                            duration: c,
                            complete: g,
                    ...
                    } else s < 9 && b ? (K.removeAlpha(b), b.style.visibility = "hidden") : e.css(f)
                },
                show: function (b, c, d) {
                    d = d || q;
                    var e = a(b);
                    ...
                    if (c) {
                        s < 9 && (e.css("opacity", 0), b.style.visibility = "visible");
                        var h = s < 9 && b ? function () {
                            1 == g.opacity && K.removeAlpha(b), d.call(b)
                        } : d;
                        K.animate(b, g, {
                            duration: c,
                            complete: h,
                    ...
                    } else s < 9 && 1 == g.opacity && b ? (K.removeAlpha(b), b.style.visibility = "visible") : e.css(g)
                },
                wait: function (d) {
                    ...
                    var e, f, g, h = K.timestamp(),
                        i = function () {
                            return f = K.timestamp(), e = f - h, K.removeFromArray(c._waiters, g), d.until(e) ? (d.success(), !1) : "number" == typeof d.timeout && f >= h + d.timeout ? (d.error(), !1) : void c._waiters.push(g = b.setTimeout(i, 10))
                        };
                    c._waiters.push(g = b.setTimeout(i, 10))
                },
                toggleQuality: function (a, b) {
                    7 !== s && 8 !== s || !a || "IMG" != a.nodeName.toUpperCase() || ("undefined" == typeof b && (b = "nearest-neighbor" === a.style.msInterpolationMode), a.style.msInterpolationMode = b ? "bicubic" : "nearest-neighbor")
                },
                insertStyleTag: function (b, c) {
                    if (!c || !a("#" + c).length) {
                        var d = e.createElement("style");
                        if (c && (d.id = c), t().head.appendChild(d), d.styleSheet) d.styleSheet.cssText = b;
                        else {
                ...
                loadCSS: function (b, f, g) {
                    ...
                    if (i = e.styleSheets.length, a("#" + f).length) a("#" + f).attr("href", b), i--;
                        ...
                        if (j.length ? j.get(0).parentNode.insertBefore(h, j[0]) : t().head.appendChild(h), s && i >= 31) return void c.raise("You have reached the browser stylesheet limit (31)", !0)
                    }
                    if ("function" == typeof g) {
                        var k = a("<s>").attr("id", "galleria-loader").hide().appendTo(t().body);
                        K.wait({
                            until: function () {
                                return k.height() > 0
                            },
        ...
        L = function (b) {
            ...
            return K.insertStyleTag(c, "galleria-videoicon"), a(K.create("galleria-videoicon")).html("<i></i>").appendTo(b).click(function () {
        ...
        M = function () {
            var b = function (b, c, d, e) {
                ...
                d ? (h.opacity = 0, i.opacity = 1) : h.opacity = 1, a(b.next).css(h), K.animate(b.next, i, {
                    duration: b.speed,
                    complete: function (a) {
                        return function () {
                            c(), a.css({
                    ...
                    left: g * (b.rewind ? 1 : -1)
                }, d && (h.opacity = 1, i.opacity = 0), a(b.prev).css(h), K.animate(b.prev, i, {
                    duration: b.speed,
                    queue: !1,
                    easing: f,
                    complete: function () {
            ...
            return {
                active: !1,
                init: function (a, b, c) {
                    M.effects.hasOwnProperty(a) && M.effects[a].call(this, b, c)
                },
                effects: {
                    fade: function (b, c) {
                        a(b.next).css({
                            ...
                            duration: b.speed,
                            complete: c
                        }), b.prev && (a(b.prev).css("opacity", 1).show(), K.animate(b.prev, {
                            opacity: 0
                        }, {
                            duration: b.speed
                        }))
                    ...
                    slide: function (a, c) {
                        b.apply(this, K.array(arguments))
                    },
                    fadeslide: function (a, c) {
                        b.apply(this, K.array(arguments).concat([!0]))
                    },
                    doorslide: function (a, c) {
                        b.apply(this, K.array(arguments).concat([!1, !0]))
                    }
                }
            }
        }();
    C.listen(), a.event.special["click:fast"] = {
        propagate: !0,
        add: function (c) {
            var d = function (a) {
            ...
            a(this).data({
                ...
                f > 6 && a(this).data("clickstate", a.extend(e, {
                    touchdown: !1
                }))
        ...
        this._options = {}, this._playing = !1, this._playtime = 5e3, this._active = null, this._queue = {
            length: 0
        }, this._data = [], this._dom = {}, this._thumbnails = [], this._layers = [], this._initialized = !1, this._firstrun = !1, this._stageWidth = 0, this._stageHeight = 0, this._target = d, this._binds = [], this._id = parseInt(1e4 * p.random(), 10);
        ...
        a.each(i.split(" "), function (a, b) {
            h._dom[b] = K.create("galleria-" + b)
        }), a.each(j.split(" "), function (a, b) {
            h._dom[b] = K.create("galleria-" + b, "span")
        });
        var k = this._keyboard = {
            ...
            o = this._tooltip = {
                ...
                init: function () {
                    ...
                    K.insertStyleTag(a, "galleria-tooltip"), h.$("tooltip").css({
                        opacity: .8,
                        visibility: "visible",
                        display: "none"
                    })
            ...
            q = this._fullscreen = {
                ...
                enter: function (a) {
                    q.beforeEnter(function () {
                        a = q.parseCallback(a, !0), h._options.trueFullscreen && C.support ? (q.active = !0, K.forceStyles(h.get("container"), {
                            width: "100%",
                            height: "100%"
                        ...
                        }, 50)) : h.$("container").addClass("fullscreen"), g.resize(q.scale), C.enter(h, a, h.get("container"))) : (q.scrolled = g.scrollTop(), c.TOUCH || b.scrollTo(0, 0), q._enter(a))
                    })
                },
                _enter: function (f) {
                    q.active = !0, u && (q.iframe = function () {
                        var d, f = e.referrer,
                            g = e.createElement("a"),
                            h = b.location;
                    ...
                    }()), K.hide(h.getActiveImage()), u && q.iframe && (q.iframe.scrolled = a(b.parent).scrollTop(), b.parent.scrollTo(0, 0));
                    var i = h.getData(),
                        j = h._options,
                        k = !h._options.trueFullscreen || !C.support,
                        l = {
                            height: "100%",
                            overflow: "hidden",
                            margin: 0,
                    ...
                    if (k && (h.$("container").addClass("fullscreen"), q.prev = h.$("container").prev(), q.prev.length || (q.parent = h.$("container").parent()), h.$("container").appendTo("body"), K.forceStyles(h.get("container"), {
                            ...
                            height: "100%",
                            zIndex: 1e4
                        }), K.forceStyles(t().html, l), K.forceStyles(t().body, l)), u && q.iframe && (K.forceStyles(q.pd.documentElement, l), K.forceStyles(q.pd.body, l), K.forceStyles(q.iframe, a.extend(l, {
                            width: "100%",
                            height: "100%",
                            top: 0,
                            left: 0,
                        ...
                        var r = h.getNext(o),
                            s = new c.Picture,
                            v = h.getData(r);
                        s.preload(h.isFullscreen() && v.big ? v.big : v.image)
                    }
                    h.rescale(function () {
                        h.addTimer(!1, function () {
                            k && K.show(h.getActiveImage()), "function" == typeof f && f.call(h), h.rescale()
                        }, 100), h.trigger(c.FULLSCREEN_ENTER)
                    }), k ? g.resize(q.scale) : K.show(h.getActiveImage())
                },
                scale: function () {
                    h.rescale()
                },
                exit: function (a) {
                    q.beforeExit(function () {
                        a = q.parseCallback(a), h._options.trueFullscreen && C.support ? C.exit(a) : q._exit(a)
                    })
                },
                _exit: function (a) {
                    q.active = !1;
                    var d = !h._options.trueFullscreen || !C.support,
                        e = h.$("container").removeClass("fullscreen");
                    if (q.parent ? q.parent.prepend(e) : e.insertAfter(q.prev), d) {
                        K.hide(h.getActiveImage()), K.revertStyles(h.get("container"), t().html, t().body), c.TOUCH || b.scrollTo(0, q.scrolled);
                        var f = h._controls.frames[h._controls.active];
                        f && f.image && (f.image.src = f.image.src)
                    }
                    u && q.iframe && (K.revertStyles(q.pd.documentElement, q.pd.body, q.iframe), q.iframe.scrolled && b.parent.scrollTo(0, q.iframe.scrolled)), h.detachKeyboard(), h.attachKeyboard(q.keymap), h._options.imageCrop = q.crop;
                    var i = h.getData().big,
                    ...
                    !h.getData().iframe && j && i && i == j.src && b.setTimeout(function (a) {
                        ...
                        h.addTimer(!1, function () {
                            d && K.show(h.getActiveImage()), "function" == typeof a && a.call(h), g.trigger("resize")
            ...
            r = this._idle = {
                ...
                hide: function () {
                    if (h._options.idleMode && h.getIndex() !== !1) {
                        ...
                        a.each(r.trunk, function (a, c) {
                            var d = c.data("idle");
                            d && (c.data("idle").complete = !1, K.animate(c, d.to, {
                ...
                show: function (b) {
                    var d = b.data("idle");
                    r.active && (d.busy || d.complete) || (d.busy = !0, h.trigger(c.IDLE_EXIT), h.clearTimer("idle"), K.animate(b, d.from, {
                ...
                init: function () {
                    if (!v.initialized) {
                        ...
                        var b = "overlay box content shadow title info close prevholder prev nextholder next counter image",
                            ...
                            l = {},
                            m = "";
                        m = s > 7 ? s < 9 ? "background:#000;filter:alpha(opacity=0);" : "background:rgba(0,0,0,0);" : "z-index:99999", j.nextholder += m, j.prevholder += m, a.each(j, function (a, b) {
                            f += ".galleria-" + i + a + "{" + b + "}"
                        }), f += ".galleria-" + i + "box.iframe .galleria-" + i + "prevholder,.galleria-" + i + "box.iframe .galleria-" + i + "nextholder{width:100px;height:100px;top:50%;margin-top:-70px}", K.insertStyleTag(f, "galleria-lightbox"), a.each(b.split(" "), function (a, b) {
                            h.addElement("lightbox-" + b), d[b] = v.elems[b] = h.get("lightbox-" + b)
                        }), v.image = new c.Picture, a.each({
                        ...
                        }), h.append(l), a(d.image).append(v.image.container), a(t().body).append(d.overlay, d.box), k(a(d.close).on("click:fast", v.hide).html("&#215;")), a.each(["Prev", "Next"], function (b, e) {
                            var f = a(d[e.toLowerCase()]).html(/v/.test(e) ? "&#8249;&#160;" : "&#160;&#8250;"),
                                g = a(d[e.toLowerCase() + "holder"]);
                            return g.on("click:fast", function () {
                                v["show" + e]()
                            }), s < 8 || c.TOUCH ? void f.show() : void g.hover(function () {
                                f.show()
                            }, function (a) {
                                f.stop().fadeOut(200)
                            })
                        }), a(d.overlay).on("click:fast", v.hide), c.IPAD && (h._options.lightboxTransitionSpeed = 0)
                    }
                },
                rescale: function (b) {
                    var d = p.min(g.width() - 40, v.width),
                        e = p.min(g.height() - 60, v.height),
                        f = p.min(d / v.width, e / v.height),
                        i = p.round(v.width * f) + 40,
                        j = p.round(v.height * f) + 60,
                        k = {
                            width: i,
                            height: j,
                            "margin-top": p.ceil(j / 2) * -1,
                            "margin-left": p.ceil(i / 2) * -1
                        };
                    b ? a(v.elems.box).css(k) : a(v.elems.box).animate(k, {
                        ...
                        complete: function () {
                            ...
                            h.trigger({
                                ...
                                opacity: 1
                            }, d), K.show(v.elems.info, d)
                        }
                    })
                },
                hide: function () {
                    v.image.image = null, g.off("resize", v.rescale), a(v.elems.box).hide().find("iframe").remove(), K.hide(v.elems.info), h.detachKeyboard(), h.attachKeyboard(v.keymap), v.keymap = !1, K.hide(v.elems.overlay, 200, function () {
                        a(this).hide().css("opacity", h._options.overlayOpacity), h.trigger(c.LIGHTBOX_CLOSE)
                    })
                },
                showNext: function () {
                    v.show(h.getNext(v.active))
                },
                showPrev: function () {
                    v.show(h.getPrev(v.active))
                },
                show: function (d) {
                    v.active = d = "number" == typeof d ? d : h.getIndex() || 0, v.initialized || v.init(), h.trigger(c.LIGHTBOX_OPEN), v.keymap || (v.keymap = a.extend({}, h._keyboard.map), h.attachKeyboard({
                        escape: v.hide,
                        right: v.showNext,
                        left: v.showPrev
                    })), g.off("resize", v.rescale);
                    ...
                    v.image.isIframe = j.iframe && !j.image, a(v.elems.box).toggleClass("iframe", v.image.isIframe), a(v.image.container).find(".galleria-videoicon").remove(), v.image.load(j.big || j.image || j.iframe, function (c) {
                        if (c.isIframe) {
                            var e = a(b).width(),
                                f = a(b).height();
                            ...
                            v.width = e, v.height = f
                        } else v.width = c.original.width, v.height = c.original.height;
                        if (a(c.image).css({
                                ...
                                opacity: 0,
                                visibility: "visible"
                            }).parent().height("100%"), v.elems.title.innerHTML = j.title || "", v.elems.counter.innerHTML = d + 1 + " / " + k, g.resize(v.rescale), v.rescale(), j.image && j.iframe) {
                            if (a(v.elems.box).addClass("iframe"), j.video) {
                                var l = L(c.container).hide();
                            ...
                            a(c.image).css("cursor", "pointer").mouseup(function (b, c) {
                                return function (d) {
                                    a(v.image.container).find(".galleria-videoicon").remove(), d.preventDefault(), c.isIframe = !0, c.load(b.iframe + (b.video ? "&autoplay=1" : ""), {
                                        width: "100%",
                                        height: s < 8 ? a(v.image.container).height() : "100%"
                                    })
                                }
                            }(j, c))
                        }
                    }), a(v.elems.overlay).show().css("visibility", "visible"), a(v.elems.box).show()
                }
            },
            w = this._timer = {
                trunk: {},
        ...
        constructor: c,
        init: function (b, e) {
            if (e = x(e), this._original = {
                    target: b,
                    options: e,
                    data: null
                }, this._target = this._dom.target = b.nodeName ? b : a(b).get(0), this._original.html = this._target.innerHTML, E.push(this), !this._target) return void c.raise("Target not found", !0);
            if (this._options = {
                    autoplay: !1,
                    carousel: !0,
                    carouselFollow: !0,
        ...
        _init: function () {
            ...
            if (a.extend(!0, h, this.theme.defaults, this._original.options, c.configure.options), h.swipe = function (a) {
                    ...
                    return "getContext" in a ? void(G = G || {
                        elem: a,
                ...
                }), K.hide(this.$("counter").append(this.get("current"), e.createTextNode(" / "), this.get("total"))), this.setCounter("&#8211;"), K.hide(f.get("tooltip")), this.$("container").addClass([c.TOUCH ? "touch" : "notouch", this._options.variation, "galleria-theme-" + this.theme.name].join(" ")), this._options.swipe || a.each(new Array(2), function (b) {
                    var d = new c.Picture;
                    a(d.container).css({
                        position: "absolute",
                        top: 0,
                        left: 0
                    }).prepend(f._layers[b] = a(K.create("galleria-layer")).css({
                        position: "absolute",
                        top: 0,
                        left: 0,
                        right: 0,
                    ...
                    if (e) {
                        if (e.iframe) {
                            ...
                            return a(g.container).css({
                                ...
                                opacity: 1
                            }, 200), void b.setTimeout(function () {
                                g.load(e.iframe + (e.video ? "&autoplay=1" : ""), {
                                    width: h,
                                    height: i
                                }, function (a) {
                    ...
                    h["show" + b.substr(0, 1).toUpperCase() + b.substr(1).replace(/-/, "")] === !1 && K.moveOut(f.get(b.toLowerCase()))
                }), this.load(), h.keepSource || s || (this._target.innerHTML = ""), this.get("errors") && this.appendChild("target", "errors"), this.appendChild("target", "container"), h.carousel) {
                var i = 0,
                    j = h.show;
                ...
                return f.$("stage").on("touchmove", function () {
                    ...
                    function (i) {
                        if (!/(-left|-right)/.test(i.target.className)) {
                            if (g = K.timestamp(), b = h(i).pageX, c = h(i).pageY, i.originalEvent.touches.length < 2 && g - a < 300 && b - d < 20 && c - e < 20) return f.toggleFullscreen(), void i.preventDefault();
                            a = g, d = b, e = c
                        }
                    }
        ...
        addTimer: function () {
            return this._timer.add.apply(this._timer, K.array(arguments)), this
        },
        clearTimer: function () {
            return this._timer.clear.apply(this._timer, K.array(arguments)), this
        },
        _getWH: function () {
            ...
            return a.each(["width", "height"], function (a, g) {
                e._options[g] && "number" == typeof e._options[g] ? f[g] = e._options[g] : (b = [K.parseValue(c.css(g)), K.parseValue(d.css(g)), c[g](), d[g]()], e["_" + g] || b.splice(b.length, K.parseValue(c.css("min-" + g)), K.parseValue(d.css("min-" + g))), f[g] = p.max.apply(p, b))
        ...
        _createThumbnails: function (d) {
            ...
            var f, g, h, i, j = this,
                ...
                n = [],
                o = 0,
                p = s < 8 ? "http://upload.wikimedia.org/wikipedia/commons/c/c0/Blank.gif" : "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw%3D%3D",
                q = function () {
                ...
                u = function (b, d, e) {
                    return function () {
                        a(e).append(b), j.trigger({
                            type: c.THUMBNAIL,
                            thumbTarget: b,
                            index: d,
                            galleriaData: j.getData(d)
                        })
                    }
                },
                v = function (b) {
                ...
                x = function (b, c) {
                    b.scale({
                        ...
                        complete: function (b) {
                            ...
                            }), K.toggleQuality(b.image, k.thumbQuality === !0 || "auto" === k.thumbQuality && b.original.width < 3 * b.width), k.thumbDisplayOrder && !b.lazy ? a.each(n, function (a, b) {
            ...
            for (d || (this._thumbnails = [], this.$("thumbnails").empty()); this._data[l]; l++) h = this._data[l], f = h.thumb || h.image, k.thumbnails !== !0 && "lazy" != r || !h.thumb && !h.image ? h.iframe && null !== r || "empty" === r || "numbers" === r ? (g = {
                ...
                width: K.parseValue(t("width")),
                height: K.parseValue(t("height")),
                order: l,
                src: f
            }, k.thumbCrop !== !0 ? i.css({
                width: "auto",
        ...
        lazyLoad: function (b, c) {
            ...
            return a.each(d, function (b, g) {
                if (!(g > e._thumbnails.length - 1)) {
                    ...
                    h.video ? k.call(e, h, j) : h.load(i.src, function (a) {
                        k.call(e, a, j)
                    })
                }
            }), this
                ...
                success: function () {
                    if (D.push(e), e._options.swipe) {
                        ...
                        a.each(new Array(e.getDataLength()), function (b) {
                            ...
                            a(d.container).css({
                            ...
                            }).prepend(e._layers[b] = a(K.create("galleria-layer")).css({
                                position: "absolute",
                                top: 0,
                                left: 0,
                                right: 0,
                                bottom: 0,
                                zIndex: 2
                            })[0]).appendTo(f), g.video && L(d.container), e._controls.slides.push(d);
                            var h = new c.Picture;
        ...
        load: function (b, d, e) {
            ...
            return this._data = [], this._thumbnails = [], this.$("thumbnails").empty(), "function" == typeof d && (e = d, d = null), b = b || g.dataSource, d = d || g.dataSelector, e = e || g.dataConfig, a.isPlainObject(b) && (b = [b]), a.isArray(b) ? this.validate(b) ? this._data = b : c.raise("Load failed: JSON Array not valid.") : (d += ",.video,.iframe", a(b).find(d).each(function (b, c) {
                ...
                var d = {},
                    ...
                    h = g.attr("href"),
                    i = g.attr("rel");
                h && ("IMG" == c[0].nodeName || c.hasClass("video")) && B(h) ? d.video = h : h && c.hasClass("iframe") ? d.iframe = h : d.image = d.big = h, i && (d.big = i), a.each("big title description link layer image".split(" "), function (a, b) {
        ...
        _parseData: function (b) {
            ...
            return a.each(this._data, function (b, f) {
                if (c = e._data[b], "thumb" in f == !1 && (c.thumb = f.image), f.big || (c.big = f.image), "video" in f) {
                    var h = B(f.video);
                    h && (c.iframe = new A(h.provider, h.id).embed() + function () {
        ...
        destroy: function () {
            return this.$("target").data("galleria", null), this.$("container").off("galleria"), this.get("target").innerHTML = this._original.html, this.clearTimer(), K.removeFromArray(E, this), K.removeFromArray(D, this), c._waiters.length && a.each(c._waiters, function (a, c) {
                c && b.clearTimeout(c)
            }), this
        },
        splice: function () {
        ...
        unbind: function (a) {
            return a = y(a), this.$("container").off(a), this
        },
        trigger: function (b) {
            return b = "object" == typeof b ? a.extend(b, {
                scope: this
            }) : {
                type: y(b),
                scope: this
        ...
        addIdleState: function (a, b, c, d) {
            return this._idle.add.apply(this._idle, K.array(arguments)), this
        },
        removeIdleState: function (a) {
            return this._idle.remove.apply(this._idle, K.array(arguments)), this
        },
        ...
        enterFullscreen: function (a) {
            return this._fullscreen.enter.apply(this, K.array(arguments)), this
        },
        exitFullscreen: function (a) {
            return this._fullscreen.exit.apply(this, K.array(arguments)), this
        },
        toggleFullscreen: function (a) {
            return this._fullscreen[this.isFullscreen() ? "exit" : "enter"].apply(this, K.array(arguments)), this
        },
        bindTooltip: function (a, b) {
            return this._tooltip.bind.apply(this._tooltip, K.array(arguments)), this
        },
        defineTooltip: function (a, b) {
            return this._tooltip.define.apply(this._tooltip, K.array(arguments)), this
        },
        refreshTooltip: function (a) {
            return this._tooltip.show.apply(this._tooltip, K.array(arguments)), this
        },
        openLightbox: function () {
            return this._lightbox.show.apply(this._lightbox, K.array(arguments)), this
        },
        closeLightbox: function () {
            return this._lightbox.hide.apply(this._lightbox, K.array(arguments)), this
        },
        ...
        addPan: function (b) {
            if (this._options.imageCrop !== !1) {
                ...
                var c = this,
                    ...
                    q = function (a, c, d) {
                        if (a > 0 && (o = p.round(p.max(a * -1, p.min(0, c))), n !== o))
                            if (n = o, 8 === s) b.parent()["scroll" + d](o * -1);
                            else {
                                var e = {};
                    ...
                    r = function (a) {
                        K.timestamp() - m < 50 || (l = !0, d = c.getMousePosition(a).x, e = c.getMousePosition(a).y)
                    },
                    t = function (a) {
                ...
                return 8 === s && (b.parent().scrollTop(i * -1).scrollLeft(h * -1), b.css({
                    top: 0,
                    left: 0
                })), this.$("stage").off("mousemove", r).on("mousemove", r), this.addTimer("pan" + c._id, t, 50, !0), this
            }
        },
        proxy: function (a, b) {
            return "function" != typeof a ? q : (b = b || this, function () {
                return a.apply(b, K.array(arguments))
            })
        },
        ...
        addElement: function (b) {
            var c = this._dom;
            return a.each(K.array(arguments), function (a, b) {
                c[b] = K.create("galleria-" + b)
            }), this
        },
        attachKeyboard: function (a) {
            return this._keyboard.attach.apply(this._keyboard, K.array(arguments)), this
        },
        detachKeyboard: function () {
            return this._keyboard.detach.apply(this._keyboard, K.array(arguments)), this
        },
        ...
        remove: function (a) {
            return this.$(K.array(arguments).join(",")).remove(), this
        },
        append: function (a) {
            var b, c;
            for (b in a)
                if (a.hasOwnProperty(b))
                    if (a[b].constructor === Array)
                        for (c = 0; a[b][c]; c++) this.appendChild(b, a[b][c]);
            ...
            if (b = b || this._controls.getActive()) {
                var d, e = function (b) {
                    a(b.container).children(":first").css({
                        top: p.max(0, K.parseValue(b.image.style.top)),
                        left: p.max(0, K.parseValue(b.image.style.left)),
                        width: K.parseValue(b.image.width),
                        height: K.parseValue(b.image.height)
                    })
                };
                return c = a.extend({
                    ...
                    d.call(b, b), e(b)
                }) : c.complete = e : a(b.container).children(":first").css({
                    top: 0,
                    left: 0
                }), b.scale(c), this
            }
        ...
        resize: function (b, c) {
            "function" == typeof b && (c = b, b = d), b = a.extend({
                width: 0,
                height: 0
            }, b);
            var e = this,
        ...
        show: function (d, e, f) {
            ...
            if (g || !(this._queue.length > 3 || d === !1 || !this._options.queue && this._queue.stalled)) {
                ...
                if (this.finger && d !== this._active && (this.finger.to = -(d * this.finger.width), this.finger.index = d), this._active = d, g) {
                    ...
                    this.trigger(a.extend(o, {
                        type: c.LOADSTART
                    })), j.$("container").removeClass("videoplay");
                    var q = function () {
                        j._layers[d].innerHTML = j.getData().layer || "", j.trigger(a.extend(o, {
                            type: c.LOADFINISH
                        })), j._playCheck()
                    };
                    j._preload(), b.setTimeout(function () {
                        l.ready && a(l.image).attr("src") == k ? (j.trigger(a.extend(o, {
                            type: c.IMAGE
                        })), q()) : (i.iframe && !i.image && (l.isIframe = !0), l.load(k, function (b) {
                            o.imageTarget = b.image, j._scaleImage(b, q).trigger(a.extend(o, {
                                type: c.IMAGE
                            })), q()
                        }))
                    }, 100)
                } else h.push.call(this._queue, {
                    index: d,
                    rewind: e
        ...
        _show: function () {
            ...
            if (g) {
                ...
                var o = function (f, g, i, j, k) {
                    return function () {
                        var l;
                        M.active = !1, K.toggleQuality(g.image, e._options.imageQuality), e._layers[e._controls.active].innerHTML = "", a(i.container).css({
                            zIndex: 0,
                            opacity: 0
                            ...
                            left: 0,
                            top: 0
                        }).show(), e._controls.swap(), e._options.imagePan && e.addPan(g.image), (f.iframe && f.image || f.link || e._options.lightbox || e._options.clicknext) && a(g.image).css({
                            cursor: "pointer"
                ...
                this._options.carousel && this._options.carouselFollow && this._carousel.follow(f.index), e._preload(), K.show(k.container), k.isIframe = g.iframe && !g.image, a(e._thumbnails[f.index].container).addClass("active").siblings(".active").removeClass("active"), e.trigger({
                    type: c.LOADSTART,
                    cached: l,
                    index: f.index,
                    rewind: f.rewind,
                    ...
                    e._scaleImage(b, {
                        complete: function (b) {
                            "image" in j && K.toggleQuality(j.image, !1), K.toggleQuality(b.image, !1), e.removePan(), e.setInfo(f.index), e.setCounter(f.index), g.layer && (h.show(), (g.iframe && g.image || g.link || e._options.lightbox || e._options.clicknext) && h.css("cursor", "pointer").off("mouseup").mouseup(n)), g.video && g.image && L(b.container);
                            ...
                            if (a.each({
                                ...
                                M.active = !0, M.init.call(e, i, k, o)
                            }
                            e.trigger({
                                type: c.LOADFINISH,
                                cached: l,
        ...
        _playCheck: function () {
            ...
            if (this._playing) {
                this.clearTimer(f);
                var g = function () {
                    return b = K.timestamp() - e, b >= a._playtime && a._playing ? (a.clearTimer(f), void a.next()) : void(a._playing && (a.trigger({
                        type: c.PROGRESS,
        ...
        setCounter: function (a) {
            if ("number" == typeof a ? a++ : "undefined" == typeof a && (a = this.getIndex() + 1), this.get("current").innerHTML = a, s) {
                var b = this.$("counter"),
                    c = b.css("opacity");
                1 === parseInt(c, 10) ? K.removeAlpha(b[0]) : this.$("counter").css("opacity", c)
            }
            return this
        },
        setInfo: function (b) {
        ...
        hasInfo: function (a) {
            ...
            for (b = 0; c[b]; b++)
                if (this.getData(a)[c[b]]) return !0;
            return !1
        },
        jQuery: function (b) {
            var c = this,
        ...
        QUIRK: s && e.compatMode && "BackCompat" === e.compatMode,
        ...
        d.name || c.raise("No theme name specified"), (!d.version || parseInt(10 * c.version) > parseInt(10 * d.version)) && c.raise("This version of Galleria requires " + d.name + " theme version " + c.version.toFixed(1) + " or later", !0), "object" != typeof d.defaults ? d.defaults = {} : d.defaults = x(d.defaults);
        var e, f, g = !1;
        return "string" == typeof d.css ? (a("link").each(function (a, b) {
            if (e = new RegExp(d.css), e.test(b.href)) return g = !0, J(d), !1
        }), g || a(function () {
            var h = 0,
                i = function () {
                    a("script").each(function (a, c) {
                        e = new RegExp("galleria\\." + d.name.toLowerCase() + "\\."), f = new RegExp("galleria\\.io\\/theme\\/" + d.name.toLowerCase() + "\\/(\\d*\\.*)?(\\d*\\.*)?(\\d*\\/)?js"), (e.test(c.src) || f.test(c.src)) && (g = c.src.replace(/[^\/]*$/, "") + d.css, b.setTimeout(function () {
                            K.loadCSS(g, "galleria-theme-" + d.name, function () {
                                J(d)
                            })
                        }, 1))
        ...
        if (!a("script").filter(function () {
            ...
            }), K.loadScript(d, function () {
                g = !0, b.clearTimeout(f)
            }), c
        }
    }, c.get = function (a) {
        return E[a] ? E[a] : "number" != typeof a ? E : void c.raise("Gallery index " + a + " not found")
        ...
        if (b) {
            d = d || q;
            var e = b + d.toString().replace(/\s/g, "") + K.timestamp();
        ...
        return a.isFunction(d) && (d = {
            extend: d
        }), a(b || "#galleria").galleria(d), c
    }, c.addTransition = function (a, b) {
        return M.effects[a] = b, c
    }, c.utils = K, c.log = function () {
        var c = K.array(arguments);
        ...
        return "function" != typeof b ? c : (a.each(D, function (a, c) {
            b.call(c, c._options)
        ...
        var d = c ? "Fatal error" : "Error",
            ...
            f = function (b) {
                ...
                }), E.length || a("<div>").css(a.extend(e, {
                    position: "fixed"
                })).append(f).appendTo(t().body)
            };
        if (j) {
            if (f(b), c) throw new Error(d + ": " + b)
        } else if (c) {
            if (F) return;
            F = !0, c = !1, f("Gallery could not load.")
        }
        ...
        this.id = b || null, this.image = null, this.container = K.create("galleria-image"), a(this.container).css({
            overflow: "hidden",
            position: "relative"
        }), this.original = {
            width: 0,
        ...
        load: function (d, e, f) {
            ...
            var i = !1,
                ...
                n = function () {
                    i ? l ? a(this).attr("src", l) : c.raise("Image not found: " + d) : (i = !0, b.setTimeout(function (a, b) {
                        return function () {
                            a.attr("src", b + (b.indexOf("?") > -1 ? "&" : "?") + K.timestamp())
                        }
                    }(a(this), d), 50))
                },
                o = function (d, f, g) {
            ...
            return k.find("iframe,img").remove(), m.css("display", "block"), K.hide(this.image), a.each("minWidth minHeight maxWidth maxHeight".split(" "), function (a, b) {
        ...
        scale: function (b) {
            ...
            return K.wait({
                until: function () {
                    return k = b.width || n.width() || K.parseValue(n.css("width")), l = b.height || n.height() || K.parseValue(n.css("height")), k && l
                },
                success: function () {
                    ...
                    }), a(e.container).width(k).height(l), b.canvas && G && (G.elem.width = e.width, G.elem.height = e.height, j = e.image.src + ":" + e.width + "x" + e.height, e.image.src = G.cache[j] || function (a) {
                        G.context.drawImage(e.image, 0, 0, e.original.width * i, e.original.height * i);
                        try {
                            return m = G.elem.toDataURL(), G.length += m.length, G.cache[a] = m, m
                        } catch (a) {
                            return e.image.src
                        }
                    }(j));
        ...
        var d = (p.abs, c.HAS3D = function () {
                var b, c, d = e.createElement("p"),
                    f = ["webkit", "O", "ms", "Moz", ""],
                    g = 0,
                    h = "transform";
                for (t().html.insertBefore(d, null); f[g]; g++) c = f[g] ? f[g] + "Transform" : h, void 0 !== d.style[c] && (d.style[c] = "translate3d(1px,1px,1px)", b = a(d).css(f[g] ? "-" + f[g].toLowerCase() + "-" + h : h));
                return t().html.removeChild(d), void 0 !== b && b.length > 0 && "none" !== b
            }()),
            g = function () {
            ...
            h = function (c, e) {
                if (this.config = {
                    ...
                    a.extend(this.config, e), this.elem = c, this.child = c.children[0], this.to = this.pos = 0, this.touching = !1, this.start = {}, this.index = this.config.start, this.anim = 0, this.easing = this.config.easing, d || (this.child.style.position = "absolute", this.elem.style.position = "relative"), a.each(["ontouchstart", "ontouchmove", "ontouchend", "setup"], function (a, b) {
                        ...
                        }, a(c).on("touchstart", this.ontouchstart), a(b).on("resize", this.setup), a(b).on("orientationchange", this.setup), this.setup(),
                        function a() {
                            g(a), f.loop.call(f)
                        }()
                }
        ...
        return h.prototype = {
            ...
            loop: function () {
                var a = this.to - this.pos,
                    b = 1;
                if (this.width && a && (b = p.max(.5, p.min(1.5, p.abs(a / this.width)))), this.touching || p.abs(a) <= 1) this.pos = this.to, a = 0, this.anim && !this.touching && this.config.oncomplete(this.index), this.anim = 0, this.easing = this.config.easing;
                else {
                    this.anim || (this.anim = {
                        start: this.pos,
                        time: +new Date,
