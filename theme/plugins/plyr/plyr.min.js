  ...
  (function (e, t) {
    ...
    var A,
      ...
      P = (function () {
        function t(i, n) {
          e(this, t),
            w(i)
              ? (this.element = i)
              : y(i) && (this.element = document.querySelector(i)),
            w(this.element) &&
              T(this.element.rangeTouch) &&
      ...
      j = function (e) {
        return (
          x(e) ||
          ((L(e) || _(e) || O(e)) && !e.length) ||
          (I(e) && !Object.keys(e).length)
        );
      },
      q = x,
      H = I,
    ...
    var ge,
      ...
      ve = {
        ...
        pip: !(
          G.isIPhone ||
          (!V(ne('video').webkitSetPresentationMode) &&
    ...
    function Pe(e) {
      return (
        !!(B(e) || (F(e) && e.includes(':'))) &&
        (B(e) ? e : e.split(':')).map(Number).every(D)
      );
    }
    function Me(e) {
        ...
        if (this.isHTML5) {
          ...
          (e.options.speed = e.config.speed.options),
            ...
            Object.defineProperty(e.media, 'quality', {
              ...
              set: function (t) {
                if (e.quality !== t) {
                  if (e.config.quality.forced && V(e.config.quality.onChange))
    ...
    var Ye = {
      ...
      createButton: function (e, t) {
        ...
        return (
          s.toggle
            ? (r.appendChild(
                Ye.createIcon.call(this, s.iconPressed, {
                  class: 'icon--pressed',
                })
              ),
              r.appendChild(
                Ye.createIcon.call(this, s.icon, { class: 'icon--not-pressed' })
              ),
              r.appendChild(
                Ye.createLabel.call(this, s.labelPressed, {
                  class: 'label--pressed',
                })
              ),
              r.appendChild(
                Ye.createLabel.call(this, s.label, {
          ...
          ie(r, n),
          'play' === a
            ? (B(this.elements.buttons[a]) || (this.elements.buttons[a] = []),
      ...
      createRange: function (e, t) {
        ...
        return (
          ...
          Ye.updateRangeFill.call(this, i),
          P.setup(i),
          i
        );
      },
          ...
          function (n) {
            if (
              ...
              if (!s && [32, 39].includes(n.which))
                Ye.showMenuPanel.call(i, t, !0);
              else
                32 !== n.which &&
                  (40 === n.which || (s && 39 === n.which)
                    ? ((a = e.nextElementSibling),
                      W(a) || (a = e.parentNode.firstElementChild))
                    : ((a = e.previousElementSibling),
                      W(a) || (a = e.parentNode.lastElementChild)),
                  fe.call(i, a, !0));
            }
          },
          !1
                ...
                (i = this.currentTime),
                  ...
                  (a =
                    0 === i || 0 === n || Number.isNaN(i) || Number.isNaN(n)
                      ...
                      : ((i / n) * 100).toFixed(2)),
                  'timeupdate' === e.type &&
                    Ye.setRange.call(this, this.elements.inputs.seek, a);
                break;
              case 'playing':
              case 'progress':
                !(function (e, i) {
      ...
      updateSetting: function (e, t, i) {
        ...
        if ('captions' === e) a = this.currentTrack;
          ...
          if (
            ((a = X(i) ? this[e] : i),
            X(a) && (a = this.config[e].default),
            !X(this.options[e]) && !this.options[e].includes(a))
          )
      ...
      setQualityMenu: function (e) {
        ...
        if (W(this.elements.settings.panels.quality)) {
          ...
          if (
            (Ye.toggleMenuButton.call(this, 'quality', n),
            re(i),
      ...
      setCaptionsMenu: function () {
        ...
        if (W(this.elements.settings.panels.captions)) {
          var t = this.elements.settings.panels.captions.querySelector(
            ...
            n = Boolean(i.length);
          if (
            (Ye.toggleMenuButton.call(this, 'captions', n),
            re(t),
            Ye.checkMenu.call(this),
            n)
          ) {
            var a = i.map(function (i, n) {
              return {
                ...
                badge:
                  i.language &&
                  Ye.createBadge.call(e, i.language.toUpperCase()),
                list: t,
                type: 'language',
              };
            });
            a.unshift({
              ...
              a.forEach(Ye.createMenuItem.bind(this)),
              Ye.updateSetting.call(this, 'captions', t);
          }
        }
      },
        ...
        return (
          Le(this.config.controls).forEach(function (o) {
            ...
            if (
              ...
              'settings' === o && !X(t.config.settings))
            ) {
              var g = ne(
                'div',
                ee({}, d, {
              ...
              b.appendChild(w),
                ...
                t.config.settings.forEach(function (n) {
                  ...
                  l.appendChild(
                    ne('span', { 'aria-hidden': !0 }, Fe(n, t.config))
                  ),
                    l.appendChild(
                      ne(
                        'span',
                        { class: t.config.classNames.hidden },
                        Fe('menuBack', t.config)
                      )
                    ),
                    ke.call(
                      t,
            ...
            if (
              ('pip' === o && ve.pip && u.appendChild(n.call(t, 'pip', d)),
              'airplay' === o &&
                ve.airplay &&
              ...
              !Q(T) &&
                t.isEmbed &&
                ee(k, { icon: 'logo-'.concat(t.provider), label: t.provider }),
        ...
        if (
          (a &&
            (F(this.config.controls)
              ? (i = o(i))
              : W(i) && (i.innerHTML = o(i.innerHTML))),
          F(this.config.selectors.controls.container) &&
            (s = document.querySelector(
              this.config.selectors.controls.container
            )),
          W(s) || (s = this.elements.container),
          s[W(i) ? 'insertAdjacentElement' : 'insertAdjacentHTML'](
            'afterbegin',
            i
          ),
        ...
        setup: function () {
          if (this.supported.ui)
            if (
              ...
              if (
                (R(n) || (n = this.config.captions.active),
        ...
        update: function () {
          ...
          this.isHTML5 &&
            ...
            ((o && this.language !== a) || !t.includes(r)) &&
              (Je.setLanguage.call(this, a), Je.toggle.call(this, n && o)),
            ue(
            ...
            if (a !== i) {
              if (
                ...
                return (
                  ...
                  void Je.set.call(this, s.indexOf(r))
                );
              }
          ...
          if (-1 !== e)
            if (D(e))
              if (e in i) {
                ...
                Je.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && Je.updateCues.call(this);
        ...
        getLabel: function (e) {
          ...
          return (
            !Y(t) &&
              ...
              (t = Je.getCurrentTrack.call(this)),
            Y(t)
              ? X(t.label)
                ? X(t.language)
                  ? Fe('enabled', this.config)
                  : e.language.toUpperCase()
                : t.label
              : Fe('disabled', this.config)
          );
        },
        ...
        function t(i) {
          ...
          e(this, t),
            ...
            ke.call(
              ...
              'dblclick',
              function (e) {
                (W(n.player.elements.controls) &&
                  n.player.elements.controls.contains(e.target)) ||
                  n.toggle();
              }
            ),
            ke.call(this, this.player.elements.container, 'keydown', function (
              e
            ) {
          ...
          i(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  if (this.enabled)
                    if (G.isIos && this.player.config.fullscreen.iosNative)
              ...
              },
              {
                key: 'target',
                get: function () {
                  return G.isIos && this.player.config.fullscreen.iosNative
                    ? this.player.media
                    : this.player.elements.container;
                },
              },
                    ...
                    ['webkit', 'moz', 'ms'].some(function (t) {
                      return (
                        !(
                          ...
                          !V(document[''.concat(t, 'CancelFullScreen')])
                        ) && ((e = t), !0)
                      );
                    }),
                    e
        ...
        build: function () {
          ...
          if ((this.listeners.media(), !this.supported.ui))
            return (
              ...
              void ot.toggleNativeControls.call(this, !0)
            );
          W(this.elements.controls) ||
            ...
            this.poster &&
              ot.setPoster.call(this, this.poster, !1).catch(function () {}),
          ...
          ue(
            ...
            Array.from(this.elements.buttons.play || []).forEach(function (e) {
              Object.assign(e, { pressed: t.playing }),
                e.setAttribute(
                  'aria-label',
                  Fe(t.playing ? 'pause' : 'play', t.config)
                );
            }),
          ...
          i(t, [
                ...
                if (
                  ...
                  if (a) {
                    ...
                    if (W(r)) {
                      ...
                      if (32 === e.which && he(r, 'button, [role^="menuitem"]'))
                        return;
                    }
                    switch (
                      ([
            ...
            },
            {
              ...
              value: function () {
                ...
                t.config.keyboard.global &&
                  we.call(t, window, 'keydown keyup', this.handleKey, e, !1),
            ...
            },
            {
              ...
              value: function () {
                ...
                !t.keyboard.global &&
                  t.keyboard.focused &&
                  ke.call(e, i.container, 'keydown keyup', this.handleKey, !1),
                  ke.call(
                    e,
                    i.container,
                  ...
                  function (t) {
                    ...
                    if (
                      ...
                      !(function (t, i, n) {
                        ...
                        l ||
                          (c
                            ? ke.call(e, window, 'resize', s)
                            : Te.call(e, window, 'resize', s));
                    }
                  }
                );
              },
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  i = t.elements;
                if (
                  (ke.call(t, t.media, 'timeupdate seeking seeked', function (
                    e
                  ) {
                ...
                ke.call(t, t.media, a, function (e) {
                  ...
                  'error' === e.type && (a = t.media.error),
                    Ae.call(t, i.container, e.type, !0, a);
                });
              },
            },
            {
                      ...
                      [13, 32].includes(i) &&
                        (13 !== i
                          ? (e.preventDefault(),
                            e.stopPropagation(),
                            Ye.toggleMenu.call(t, e))
                          : Ye.focusFirstMenuItem.call(t, null, !0));
                    },
                    null,
                    !1
                  ),
    ...
    var ht = {
      ...
      ready: function () {
        ...
        l.setAttribute('src', c),
          ...
          X(i.referrerPolicy) ||
            l.setAttribute('referrerPolicy', i.referrerPolicy);
        var u = ne('div', {
          poster: t.poster,
          ...
          Ve(_e(t.config.urls.vimeo.api, o), 'json').then(function (e) {
            if (!X(e)) {
              ...
              (i.pathname = ''.concat(i.pathname.split('_')[0], '.jpg')),
                ot.setPoster.call(t, i.href).catch(function () {});
            }
          }),
        ...
        Object.defineProperty(t.media, 'loop', {
          ...
          t.embed.on('loaded', function () {
            ...
            W(t.embed.element) && t.supported.ui) &&
    ...
    var ft = {
        setup: function () {
          ...
          if (
            ...
            H(window.YT) && V(window.YT.Player))
          )
            ft.ready.call(this);
          else {
              ...
              events: {
                ...
                onStateChange: function (t) {
                  ...
                  switch (
                    ...
                    e.media.seeking &&
                      [1, 2].includes(t.data) &&
                      ((e.media.seeking = !1), Ae.call(e, e.media, 'seeked')),
                    t.data)
                  ) {
                    case -1:
                      Ae.call(e, e.media, 'timeupdate'),
              ...
              value: function () {
                ...
                var i = function () {
                  var t = Ke(Math.max(e.manager.getRemainingTime(), 0)),
                    i = ''
                      .concat(Fe('advertisement', e.player.config), ' - ')
                      .concat(t);
                ...
                function () {
                  ...
                  Object.assign(t, {
                    ...
                    t.isHTML5 &&
                      ...
                      wt.insertElements.call(t, 'track', e.tracks),
              ...
              if (ve.check().api) {
                ...
                switch (r) {
                  case 'div':
                    ...
                    if (
                      X(this.provider) ||
                      !Object.keys(et).includes(this.provider)
                    )
          ...
          i(
            ...
            [
              ...
              },
              {
                ...
                set: function (e) {
                  var t = this,
                    i = null;
                  D(e) && (i = e),
                    D(i) || (i = this.storage.get('speed')),
                    D(i) || (i = this.config.speed.selected);
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? ot.setPoster.call(this, e, !1).catch(function () {})
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? F(e) && Pe(e)
                      ? ((this.config.ratio = e), xe.call(this))
                      : this.debug.error(
                ...
                set: function (e) {
                  if (ve.pip) {
                    ...
                    V(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? Ge : Ze),
